...
(function () {
  var CardEditor = function (_React$Component) {
    _inherits(CardEditor, _React$Component);

    function CardEditor() {
      _classCallCheck(this, CardEditor);

      return _possibleConstructorReturn(this, (CardEditor.__proto__ || Object.getPrototypeOf(CardEditor)).apply(this, arguments));
    }

    _createClass(CardEditor, [{
      key: "submitCard",
